...
public class MemberAddController implements Initializable {
    ...
    private void addMember(ActionEvent event) {
        ...
        if (flag) {
            AlertMaker.showErrorMessage("Islem tamamlanamiyor", "Lutfen tum bilgileri giriniz!");
            return;
        }
        ...
        if (handler.execAction(st)) {
            AlertMaker.showSimpleAlert("Uye Eklendi", "Kaydedildi");
        } else {
            AlertMaker.showErrorMessage("Uye Eklenemedi", "Hatta Olustu");
        }
    }
    ...
    private void handleUpdateMember() 
    {
        ...
        if (DatabaseHandler.getInstance().updateMember(member)) {
            AlertMaker.showSimpleAlert("Basarili", "Uye Guncellendi");
        } else {
            AlertMaker.showErrorMessage("Basarisiz! Armut!", "Uyeyi guncelleyemiyorsun! Acaba neden?! :D");
        }
    }
